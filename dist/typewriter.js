        ...
        Object.defineProperty(exports, "__esModule", {
            ...
            methods: {
                ...
                canContinue: function() {
                    return this.finishTyping && this.$emit("finished"), !this.isWaiting && (!(this.isTyping && !this.finishTyping && this.hasStarted) && (!(this.isErasing && !this.isErased && this.hasStarted) && (!this.isTyping || !this.finishTyping || (this.isTyping = !this.isTyping, 
                    this.doFullErase(), !1))));
                },
